...
// Request to check permissions for a file
type CheckPermissionRequest struct {
	...
	Action     string `protobuf:"bytes,2,opt,name=action,proto3" json:"action,omitempty"`                           // Action to perform (e.g., "read", "write", "delete")
	ResourceId string `protobuf:"bytes,3,opt,name=resource_id,json=resourceId,proto3" json:"resource_id,omitempty"` // File ID or folder ID
}
...
// Response with permission result
type CheckPermissionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Allowed bool `protobuf:"varint,1,opt,name=allowed,proto3" json:"allowed,omitempty"` // Whether the user is allowed to perform the action
}
...
var file_permissions_proto_rawDesc = []byte{
	...
	0x22, 0x6a, 0x0a, 0x16, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0a, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x22, 0x33, 0x0a, 0x17,
	...
	,
...
var file_permissions_proto_goTypes = []any{
	(*CheckPermissionRequest)(nil),  // 0: permissions.CheckPermissionRequest
	(*CheckPermissionResponse)(nil), // 1: permissions.CheckPermissionResponse
}
var file_permissions_proto_depIdxs = []int32{
	0, // 0: permissions.PermissionsService.CheckPermission:input_type -> permissions.CheckPermissionRequest
	1, // 1: permissions.PermissionsService.CheckPermission:output_type -> permissions.CheckPermissionResponse

...
const (
	FileDownloaderService_DownloadFile_FullMethodName = "/file_downloader.FileDownloaderService/DownloadFile"
)
...
func (c *fileDownloaderServiceClient) DownloadFile(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*DownloadResponse, error) {
...
func (UnimplementedFileDownloaderServiceServer) DownloadFile(context.Context, *DownloadRequest) (*DownloadResponse, error) {
...
func _FileDownloaderService_DownloadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileDownloaderServiceServer).DownloadFile(ctx, req.(*DownloadRequest))
	}
...
var FileDownloaderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "file_downloader.FileDownloaderService",
